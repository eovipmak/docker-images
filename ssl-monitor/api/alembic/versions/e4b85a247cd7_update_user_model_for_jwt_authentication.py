...
def upgrade() -> None:
    ...
    # WARNING: This migration drops the existing users table and all user data.
    # This is a breaking change that cannot preserve existing username-based accounts
    # because the new schema uses email-based authentication.
    # 
    # For production environments with existing data:
    # 1. Back up the database before running this migration
    # 2. Export existing user data if needed
    # 3. Users will need to re-register with their email addresses
    # 
    ...
    # In production, this would need a custom data migration script
