...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "https://github.com/eovipmak/v-insight",
            "email": "support@v-insight.com"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entities.AlertChannel"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateAlertChannelRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/alert-channels/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated alert channel configuration",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateAlertChannelRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Alert channel updated successfully",
                        "schema": {
                            "$ref": "#/definitions/entities.AlertChannel"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Alert channel deleted successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entities.AlertRuleWithChannels"
                            }
                        }
                    },
                    "401": {
        ...
        "/alert-rules/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated alert rule configuration",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/alert-rules/{id}/test": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Alert rule validation result",
                        "schema": {
                            "type": "object",
        ...
        "/auth/me": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "User information including id, email, and tenant_id",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entities.Monitor"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateMonitorRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/monitors/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated monitor configuration",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateMonitorRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/monitors/{id}/checks": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of monitor checks",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entities.MonitorCheck"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "24h",
                        "description": "Time period for metrics (24h, 7d, or 30d)",
                        "name": "period",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Monitor metrics including uptime, response time history, and status code distribution",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Invalid request or period parameter",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/monitors/{id}/ssl-status": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "SSL status and alert threshold",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        "entities.AlertChannel": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/entities.ChannelConfig"
                },
                "created_at": {
                    "type": "string"
                },
                ...
                "type": {
                    "description": "'webhook', 'discord', 'email'",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "entities.AlertRuleWithChannels": {
            "type": "object",
            "properties": {
                "channel_ids": {
                    "type": "array",
                ...
                "trigger_type": {
                    "description": "'down', 'ssl_expiry', 'slow_response'",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "handlers.CreateAlertChannelRequest": {
            "type": "object",
            "required": [
                "config",
                "name",
        ...
        "handlers.DashboardData": {
            ...
            "properties": {
                "open_incidents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.IncidentWithDetails"
                    }
                },
                "recent_checks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.MonitorCheckWithMonitor"
                    }
                },
                "stats": {
                    "$ref": "#/definitions/handlers.DashboardStats"
        ...
        "handlers.IncidentResponse": {
            ...
            "properties": {
                ...
                "channels": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.ChannelInfo"
                    }
                },
                "created_at": {
                    "type": "string"
        ...
        "handlers.MonitorCheckWithMonitor": {
            "type": "object",
            "properties": {
                "check": {
                    "$ref": "#/definitions/entities.MonitorCheck"
        ...
        "handlers.UpdateAlertChannelRequest": {
            "type": "object",
            "properties": {
                "config": {
                    "type": "object",
