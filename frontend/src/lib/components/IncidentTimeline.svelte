...
<div class="bg-white dark:bg-slate-800 shadow-sm ring-1 ring-slate-900/5 dark:ring-slate-700 sm:rounded-lg overflow-hidden">
	<div class="px-4 py-5 sm:p-6">
		<h3 class="text-base font-semibold leading-6 text-slate-900 dark:text-white mb-6">Incident Timeline</h3>
		
		{#if events.length === 0}
			<p class="text-sm text-slate-500 dark:text-slate-400">No timeline events available</p>
		{:else}
			<div class="flow-root">
						...
						<li>
							<div class="relative pb-8">
								...
								<div class="relative flex space-x-3">
									<div>
										{#if event.type === 'start'}
											<span class="h-8 w-8 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center ring-8 ring-white dark:ring-slate-800">
										...
										{:else if event.type === 'notify'}
											<span class="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center ring-8 ring-white dark:ring-slate-800">
										...
										{:else if event.type === 'resolve'}
											<span class="h-8 w-8 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center ring-8 ring-white dark:ring-slate-800">
