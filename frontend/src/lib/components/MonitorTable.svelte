				...
				>
					...
					<div class="mt-auto pt-4 border-t border-slate-100 dark:border-slate-700 flex justify-between items-center">
						...
						<div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
							<button
								class="p-1.5 text-slate-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:bg-blue-50 dark:focus-visible:bg-blue-900/20 rounded-md transition-colors outline-none"
							...
							<button
								class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 dark:hover:text-red-400 dark:hover:bg-red-900/20 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:bg-red-50 dark:focus-visible:bg-red-900/20 rounded-md transition-colors outline-none"
