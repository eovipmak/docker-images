<script lang="ts">
	...
	const authenticatedNavItems = [
		...
		{ 
            href: '/status-pages', 
            label: 'Status Pages', 
            icon: '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192L12.888 3.75H8.25A2.25 2.25 0 006 6v11.25A2.25 2.25 0 008.25 19.5H12M8.25 19.5h3.75v-3.75H8.25v3.75z" />' 
        },
		{ 
            href: '/settings', 
            label: 'Settings', 
