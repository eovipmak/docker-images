...
<div class="min-h-screen flex items-center justify-center bg-dark-950 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans selection:bg-brand-orange selection:text-white">
	...
	<div class="max-w-md w-full space-y-8 relative z-10">
		<div class="text-center">
            <a href="/" aria-label="Back to Home" class="mx-auto w-16 h-16 flex items-center justify-center bg-gradient-to-br from-brand-blue to-teal-400 rounded-2xl shadow-[0_0_20px_rgba(0,194,255,0.3)] mb-6 transform hover:scale-105 transition-transform duration-300 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:ring-offset-2 focus:ring-offset-dark-950">
