...
Then create `frontend/src/routes/domains/[id]/+page.svelte` with the content below.

**Important:** This is a ONE-TIME setup. The `[id]` directory is a SvelteKit dynamic route that automatically handles ALL monitors. You don't need to run this for each monitor you add.

---

## File Content

Copy this into `frontend/src/routes/domains/[id]/+page.svelte`:
...
<script lang="ts">
	...
	async function loadMonitorData() {
		...
		try {
			...
			// Load check history (last 100 checks for 24 hours at 5min intervals)
...
<div class="max-w-7xl mx-auto">
	...
	{:else if monitor}
		...
		<!-- Check History Chart (Simple Bar Visualization) -->
		...
		<!-- Response Time Chart (Simple Line Visualization) -->
		<div class="bg-white rounded-lg shadow-md p-6 mb-8">
